...
import com.dishcuss.foodies.Adapters.CurrentSearchAdapter;
import com.dishcuss.foodies.Adapters.SearchRestaurantNearbySuggestionsAdapter;
import com.dishcuss.foodies.Fragments.NearbyFragmentGoogleMap;
...
import com.dishcuss.foodies.Model.SearchModel;
...
public class SearchMainActivity extends AppCompatActivity implements
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mGoogleApiClient = new GoogleApiClient.Builder(SearchMainActivity.this)
        ...
        nearbySearchLayoutManager = new LinearLayoutManager(SearchMainActivity.this);
...
//                                userProfile=userProfileRealm;
                            ...
                            CurrentSearchAdapter adapter1 = new CurrentSearchAdapter(searchModel,SearchMainActivity.this);
...
//                                        final FoodItems managedFoodItems = realm.copyToRealm(foodItems);
                            ...
                            SearchRestaurantNearbySuggestionsAdapter adapter = new SearchRestaurantNearbySuggestionsAdapter(restaurantRealmList,SearchMainActivity.this);
    ...
    protected void startLocationUpdates() {
        if (ActivityCompat.checkSelfPermission(SearchMainActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED && ActivityCompat.checkSelfPermission(SearchMainActivity.this, Manifest.permission.ACCESS_COARSE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            return;
        }
        ...
        switch (status.getStatusCode()) {
            ...
            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                ...
                try {
                    ...
                    status.startResolutionForResult(SearchMainActivity.this, REQUEST_CHECK_SETTINGS);
    ...
    void SetRecentSearchLinearLayouts(){
        ...
        if(recentSearchModelRealmResults.size()>=4)
        {
            ...
            Constants.PicassoImageSrc(recentSearchModelRealmResults.get(recentSearchModelRealmResults.size()-1).getAvatar(), recent_search_image_1, SearchMainActivity.this);
            ...
            Constants.PicassoImageSrc(recentSearchModelRealmResults.get(recentSearchModelRealmResults.size()-2).getAvatar(), recent_search_image_2, SearchMainActivity.this);
            ...
            Constants.PicassoImageSrc(recentSearchModelRealmResults.get(recentSearchModelRealmResults.size()-3).getAvatar(), recent_search_image_3, SearchMainActivity.this);
            ...
            Constants.PicassoImageSrc(recentSearchModelRealmResults.get(recentSearchModelRealmResults.size()-4).getAvatar(), recent_search_image_4, SearchMainActivity.this);
