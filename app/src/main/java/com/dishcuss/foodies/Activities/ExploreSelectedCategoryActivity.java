...
import com.dishcuss.foodies.Adapters.ExploreAdapter;
 ...
 */
public class ExploreSelectedCategoryActivity extends AppCompatActivity {
...
//                                        final FoodItems managedFoodItems = realm.copyToRealm(foodItems);
                            ...
                            ExploreAdapter adapter = new ExploreAdapter(restaurantRealmList,ExploreSelectedCategoryActivity.this);
