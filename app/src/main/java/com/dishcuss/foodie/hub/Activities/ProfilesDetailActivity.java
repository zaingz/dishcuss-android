...
import com.dishcuss.foodie.hub.Fragments.AccountBeenThereFragment;
import com.dishcuss.foodie.hub.Fragments.AccountFollowersFragment;
import com.dishcuss.foodie.hub.Fragments.AccountFollowingFragment;
import com.dishcuss.foodie.hub.Fragments.AccountReviewsFragment;
import com.dishcuss.foodie.hub.Fragments.TestFragment;
 ...
 */
public class ProfilesDetailActivity extends AppCompatActivity {
    ...
    int reviewsCount=0, followersCount =0, followingCount =0;
                    ...
                    public void run() {
                        try {
                            ...
                            if(jsonObj.has("user"))
                            {
                                ...
                                followingCount =jsonDataFollowingArray.length();
                                ...
                                userProfileRealm.setCommentsCount(followingCount);
