...
import com.dishcuss.foodie.hub.Adapters.HomeLocalFeedsAdapter;
import com.dishcuss.foodie.hub.Adapters.HomePeopleAroundAdapter;
import com.dishcuss.foodie.hub.Fragments.HomeViewPagerFragment;
...
public class HomeFragment extends Fragment {
    ...
    HomeLocalFeedsTestAdapter homeLocalFeedsTestAdapter;
...
//                            kjfghlkshljhak
                            Log.e("LocalFeedCheckIns",""+localFeeds.getLocalFeedCheckInRealmList().size());
                            Log.e("LocalFeedReview",""+localFeeds.getLocalFeedReviewRealmList().size());

                            objects.addAll(localFeeds.getLocalFeedReviewRealmList());
                            objects.addAll(localFeeds.getLocalFeedCheckInRealmList());

                            homeLocalFeedsTestAdapter = new HomeLocalFeedsTestAdapter(objects,getActivity());
                            localFeedsRecyclerView.setAdapter(homeLocalFeedsAdapter);

//                            homeLocalFeedsTestAdapter.notifyDataSetChanged();
                            realm.commitTransaction();
                            realm.close();
